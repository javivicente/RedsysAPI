...
values = {
            ...
            'Ds_Merchant_Amount': 5.5, # the module is prepare to transform floats to the format required by REDSYS
            'Ds_Merchant_Currency': '978', #Euros
            'Ds_Merchant_Order': 'your_unique_order_number',
            'Ds_Merchant_MerchantURL': 'your_merchant_URL',
            'Ds_Merchant_ProductDescription': _(u'Service Fee'),
...
# obtain payment button and the merchant order from the values supplied:
